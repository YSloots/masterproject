"""
This script is used to generate instances of nifty turbulent fields with
non uniform distance bins and resolution.
These instances are then rescaled, plotted and saved.
"""
